...
class Sentence:
    ...
    def known_mines(self, mines=set()):
        """
        Returns the set of all cells in self.cells known to be mines.
        """
        return {cell for cell in self.cells if cell in mines}

    def known_safes(self, safes=set()):
        """
        Returns the set of all cells in self.cells known to be safe.
        """
        return {cell for cell in self.cells if cell in safes}
    ...
    def mark_mine(self, cell):
        ...
        if cell in self.cells:
            ...
            self.count -= 1  # Decrease mine count as one mine is removed from the set
        if self.count == 0:
            return self
        return None
    ...
    def mark_safe(self, cell):
        ...
        if cell in self.cells:
            self.cells.remove(cell)
        return self if len(self.cells) > 0 else None
...
class MinesweeperAI:
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence: Sentence = Sentence(neighbors, count)
        self.knowledge.append(new_sentence)
        # 4)
        made_change: bool = True
        while made_change:
            made_change = False
